...
DOMINIOS = {
    "Legislación": [
        "boe.es", "congreso.es", "senado.es",
        "mjusticia.gob.es", "eur-lex.europa.eu",
        "agenciatributaria.es", "seg-social.es", "sepe.es"
    ],
    "Jurisprudencia": [
        "poderjudicial.es", "mjusticia.gob.es",
        "boe.es", "abogacia.es", "fiscal.es"
    ],
    "Consulta general": [
        "boe.es", "poderjudicial.es", "congreso.es",
        "eur-lex.europa.eu", "mjusticia.gob.es",
        "noticias.juridicas.com", "iberley.es",
        "agenciatributaria.es", "seg-social.es"
    ]
}
